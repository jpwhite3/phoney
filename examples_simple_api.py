...
def example_basic_generation():
    ...
    examples = ["name", "email", "phone", "address", "company"]
...
if __name__ == "__main__":
    ...
    print(
        "Make sure the server is running: poetry run uvicorn phoney.app.main:app --reload"
    )
    print()
    ...
    try:
        ...
        print(
            "Please start the server with: poetry run uvicorn phoney.app.main:app --reload"
        )

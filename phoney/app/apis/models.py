...
class TemplateField(BaseModel):
    ...
    parameters: dict[str, Any] | None = Field(default=None, description="Parameters to pass to the generator")
    array_count: int | None = Field(default=None, description="If specified, generate an array of this size")
    nested_path: str | None = Field(default=None, description="Dot notation path for nested placement")
...
class BulkTemplate(BaseModel):
    ...
    locale: str | None = Field(default=None, description="Locale for localized data generation")
...
class BulkTemplateResponse(BaseModel):
    ...
    template_id: str | None = Field(default=None, description="Unique identifier for this template execution")
    ...
    data: list[dict[str, Any]] | str = Field(..., description="Generated data (JSON array or CSV string)")
    ...
    execution_time_ms: float | None = Field(default=None, description="Time taken to generate data")
...
class TemplateValidationResponse(BaseModel):
    ...
    estimated_size: int | None = Field(default=None, description="Estimated output size for count=1")
